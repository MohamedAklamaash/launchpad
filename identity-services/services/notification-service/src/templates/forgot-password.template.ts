...
export const getForgotPasswordTemplate = (otp: string, userName: string) =>
    renderEmail({
        ...
        contentHtml: `<div style="margin:28px 0 0;padding:26px;text-align:center;background:#0e0e10;border:1px solid #26262b;border-radius:12px;">
            <div style="font-family:'SF Mono',SFMono-Regular,Menlo,Consolas,monospace;font-size:11px;font-weight:600;letter-spacing:2px;color:#71717a;text-transform:uppercase;margin:0 0 12px;">Reset code</div>
          ...
          <p style="margin:16px 0 0;font-size:13px;line-height:1.6;color:#71717a;">This code expires shortly and can only be used once. Never share it &mdash; Launchpad staff will never ask for it.</p>`,
    });
